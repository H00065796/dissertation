...
module "web_ecs_service" {
  ...
  name                = "${data.terraform_remote_state.dev.outputs.env_tag}-${data.terraform_remote_state.dev.outputs.web_name}-service"
  ...
  container_name      = data.terraform_remote_state.dev.outputs.web_name

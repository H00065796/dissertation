...
module "web_autoscaling_group" {
  ...
  name                      = "TF-ASG-${data.terraform_remote_state.env.outputs.env_name}-${data.terraform_remote_state.env.outputs.web_name}"
  ...
  vpc_zone_identifier       = [data.terraform_remote_state.env.outputs.web_subnet1_id, data.terraform_remote_state.env.outputs.web_subnet2_id, data.terraform_remote_state.env.outputs.web_subnet3_id]

...
module "app_autoscaling_group" {
  ...
  name                      = "TF-ASG-${data.terraform_remote_state.dev.outputs.env_name}-${data.terraform_remote_state.dev.outputs.app_name}"
  ...
  vpc_zone_identifier       = [data.terraform_remote_state.dev.outputs.app_subnet1_id, data.terraform_remote_state.dev.outputs.app_subnet2_id, data.terraform_remote_state.dev.outputs.app_subnet3_id]

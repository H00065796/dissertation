...
variable "web_target_group1_port" { type = number }
variable "web_target_group2_port" { type = number }
...
variable "app_target_group1_port" { type = number }
variable "app_target_group2_port" { type = number }
...
variable "app2_target_group1_port" { type = number }
variable "app2_target_group2_port" { type = number }
